...
const dater = new Date(2024,5,28, 10, 12,45, 231); // 5 is June, 0 is January
console.log(dater.toString());
...
const date21 = new Date("2025-04-21");

console.log(date21-date12); //>, <, etc can be used
